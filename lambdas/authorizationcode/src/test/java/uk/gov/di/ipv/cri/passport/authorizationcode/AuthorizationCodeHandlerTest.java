...
//            new DcsResponse(
//                    UUID.randomUUID().toString(), UUID.randomUUID().toString(), false, true,
// null);
//
//    private final DcsResponse invalidDcsResponse =
//            new DcsResponse(
//                    UUID.randomUUID().toString(), UUID.randomUUID().toString(), false, false,
// null);
//
...
//        assertEquals(
//                params.get(OAuth2RequestParams.REDIRECT_URI),
// redirectUrlArgumentCaptor.getValue());
//    }
//
//    @Test
