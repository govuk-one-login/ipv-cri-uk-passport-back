...
public class PassportCriResponse {
    ...
    public static PassportCriResponse fromPassportCheckDao(PassportCheckDao passportCheck) {
        Attributes attributes =
                new Attributes.Builder()
                        .setNames(
                                new Name(
                                        passportCheck.getAttributes().getSurname(),
                                        passportCheck.getAttributes().getForenames()))
                        .setPassportNumber(passportCheck.getAttributes().getPassportNumber())
                        .setDateOfBirth(passportCheck.getAttributes().getDateOfBirth())
                        ...
                        .build();
        return new PassportCriResponse(
                passportCheck.getResourceId(), attributes, passportCheck.getGpg45Score());
    }
