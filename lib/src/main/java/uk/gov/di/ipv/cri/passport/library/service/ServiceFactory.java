...
public class ServiceFactory {
    ...
    public ServiceFactory(ObjectMapper objectMapper)
            throws NoSuchAlgorithmException, InvalidKeyException, IOException, CertificateException, InvalidKeySpecException, KeyStoreException {
    ...
    public PassportSessionService getPassportSessionService() {
        return passportSessionService;
    }
}
